...
public class ChessMatch {
    ...
    private boolean check; // começa como falso
    ...
    private Piece makeMove (Position source, Position target) {
        ...
        if(p instanceof King && target.getColum() == source.getColum() + 2) {
            ...
            Position sourceSideRook = new Position(source.getRow(), source.getColum() + 3);
            Position targetSideRook = new Position(source.getRow(), source.getColum() + 1);
            ChessPiece rook = (ChessPiece)board.removePiece(sourceSideRook);
            board.placePiece(rook, targetSideRook);
        ...
        if(p instanceof King && target.getColum() == source.getColum() - 2) {
            ...
            Position sourceSideRook = new Position(source.getRow(), source.getColum() - 4);
            Position targetSideRook = new Position(source.getRow(), source.getColum() - 1);
            ChessPiece rook = (ChessPiece)board.removePiece(sourceSideRook);
            board.placePiece(rook, targetSideRook);
            rook.increaseMoveCount();
    ...
    private void undoMove (Position source, Position target, Piece capturedPiece) {
        ...
        if(p instanceof King && target.getColum() == source.getColum() + 2) {
            ...
            Position sourceSideRook = new Position(source.getRow(), source.getColum() + 3);
            Position targetSideRook = new Position(source.getRow(), source.getColum() + 1);
            ChessPiece rook = (ChessPiece)board.removePiece(targetSideRook);
            board.placePiece(rook, sourceSideRook);
    ...
    private void validateSourcePosition (Position position) {
        ...
        if(currentPlayer != ((ChessPiece)board.piece(position)).getColor()) {
            throw new ChessException("The chosen piece its not urs");
        }
